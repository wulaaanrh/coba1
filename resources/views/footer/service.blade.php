    ...
    <div class="services container">
      ...
      <div class="service-bottom">
        ...
        <div class="service-item">
          <div class="icon"><img src="https://img.icons8.com/bubbles/100/000000/services.png" /></div>
          <h2>Web Personal</h2>
          <p>A personal website or personal website is a type of website that is owned by an individual, even though it is a personal website, but not only the content that is personal from the website owner.</p>
        </div>
      </div>
    </div>
  </section>
